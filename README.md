Implementacia klientskej applikacie pre server podla zadania.
...
./main UPLOAD path/to/file  --> uploads file to server

./main DELETE <hash>     --> deletes file with corresponding hash
